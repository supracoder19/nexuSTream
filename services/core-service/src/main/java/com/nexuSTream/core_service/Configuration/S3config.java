...
public class S3config {
    ...
    public S3Client primaryS3Client(S3propsFromProperties props) {
        return createS3Client(props.region(),props.accessKey(),props.secretKey(),props.pathStyleAccess(), props.endpoint());
    }
    ...
    public S3Client secondaryS3Client(S3propsFromProperties props) {
        ...
        return createS3Client(props.region_2(),props.accessKey_2(),props.secretKey_2(),props.pathStyleAccess_2(), props.endpoint_2());
    }
    ...
    // Private helper method to keep your configuration code DRY (Don't Repeat Yourself)
    private S3Client createS3Client(String region, String accessKey,String sercetKey,boolean pathStyle, String endpoint) {
